            ...
            <div className="web-view ">
                ...
                <div className="proj2-container">
                    <div className="proj2-description">
                        <h1>Calendly Website</h1>
                        <p>Clone of Calendly Project. Added animations and video player and use of css animation with the help of Youtube. Used Chakra UI for most of the react project.The Website is fully responsive. The Website containes animations as well as used crauser and videos.</p>
                        <div className="proj1-demo-btn">
                            <Link  href="https://reactproject-neon.vercel.app/login" isExternal><button>See Demo</button></Link>
                            <Link  href="https://github.com/crusher8010/-noble-volleyball-6086/tree/main/reactproject/src" isExternal><button>Source Code</button></Link>
                        </div>
                    </div>
